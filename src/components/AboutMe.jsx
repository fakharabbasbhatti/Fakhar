        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="flex flex-col lg:flex-row items-center gap-10 lg:gap-12">
            ...
            <div className="w-full lg:w-3/5 space-y-6 text-center lg:text-left">
              ...
              >
                I'm <span className="text-[#38bdf8]">Kazim Jaffery</span>, a
              ...
              >
                I build modern, high-performance mobile applications for both
                Android & iOS using clean architecture and optimized code. My
                focus is creating user-friendly, scalable and visually appealing
                mobile experiences using technologies like Kotlin, Java, Swift,
