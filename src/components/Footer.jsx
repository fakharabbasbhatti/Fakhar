...
const socialLinks = [
  ...
  { icon: <FaLinkedin />, href: "https://www.linkedin.com/", label: "LinkedIn", color: "hover:text-blue-500" },
  { icon: <FaEnvelope />, href: "mailto:info@gmail.com", label: "Email", color: "hover:text-[#38bdf8]" },
];
      ...
      <div className="bg-gray-900 pt-2 pb-6 relative z-10">
        <div className="flex flex-col items-center max-w-screen-xl mx-auto border-t border-gray-300 pt-5 text-gray-200 text-sm">
          <p>
            ...
            <span className="font-bold">Kazim Jaffery</span> © {new Date().getFullYear()}
          </p>
        </div>
      </div>
